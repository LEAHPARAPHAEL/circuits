...
def test_ioi_circuit(args):
    ...
    run_ioi_task(model, loader, criterion, device, args, size, template_key,"gpt2")
    ...
    run_ioi_task(model, loader, criterion, device, args, size, template_key,ablation_config["name"])
